...
export class WorkspaceTurnResolver {
  ...
  async resolve(sourceWorkspaceId: string, options: ResolveWorkspaceTurnOptions = {}): Promise<ResolvedWorkspaceTurn> {
  ...
  private async run(sourceWorkspaceId: string, attempt: ActiveAttempt): Promise<ResolvedWorkspaceTurn> {
