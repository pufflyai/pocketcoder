import { type Agent, type Harness, ServiceSchema, type TemplateService, type TemplateSpec } from "./template-schema";
...
export function isAgentApiNative(spec: TemplateSpec): spec is Extract<TemplateSpec, { agent: Agent }> {
