...
import { asBytes, asDate, MAX_LOG_BYTES, type Row } from "./store-base";
import { PostgresOutputStore } from "./store-outputs";

export class PostgresLogStore extends PostgresOutputStore {
	async appendLogs(
		workspaceId: string,
