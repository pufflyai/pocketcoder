...
export function addTerminalCommand(parser: Argv) {
  return addAction(
    parser,
    "terminal",
    "Open or reattach to an interactive terminal",
    (command) =>
...
async function attachTerminal(flags: Flags, client: PocketCoderClient): Promise<number> {
