...
import { toResource, type WorkspaceService } from "../workspaces/service";
  ...
  app.openapi(
    ...
    async (c) => {
      ...
      if (checkpoint.conversationRestore !== "supported") {
        ...
        throw new ApiError("resume.unsupported", "This checkpoint cannot restore conversation context.", {
          reason,
