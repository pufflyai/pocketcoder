...
import { decodeSequenceCursor, decodeStringCursor, encodeCursor } from "../http/pagination";
      ...
      return c.json(
        {
          items: items.map((session) => ({
            ...
            duration_ms: session.closedAt ? session.closedAt.getTime() - session.openedAt.getTime() : null,
