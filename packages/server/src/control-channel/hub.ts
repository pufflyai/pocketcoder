...
export class Hub implements ConnectionHub {
  ...
  terminalClientMessage(
    ...
    this.terminals.clientMessage(bridge, message, (type, payload) => this.send(conn, type, payload));
  }
  ...
  nextAttachment(conn: LiveConnection, operationId: string, timeoutMs: number): Promise<AttachmentEvent | null> {
