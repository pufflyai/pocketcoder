...
type SendAgent = (type: "terminal_open" | "terminal_input" | "terminal_resize", payload: unknown) => void;
...
export class TerminalBridgeRegistry {
  ...
  output(workspaceId: string, payload: TerminalOutput): void {
    ...
    if (bridge.client) this.sendClient(bridge.client, { type: "output", data_b64: payload.data_b64 });
  }
